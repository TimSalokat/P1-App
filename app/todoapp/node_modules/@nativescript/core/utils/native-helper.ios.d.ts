...
export declare function dataSerialize(data: any, wrapPrimitives?: boolean): string | number | boolean | NSArray<unknown> | NSDate | NSNumber | NSDictionary<unknown, unknown>;
